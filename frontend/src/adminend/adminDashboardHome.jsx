// adminend/AdminDashboardHome.jsx
    ...
    <div className="dashboard-home">
      ...
      <div className="quick-actions">
        ...
        <div className="actions-grid">
          <Link to="/admin/dashboard/vieworders" className="showcase-card">
          ...
          <Link to="/admin/dashboard/updateorders" className="showcase-card">
            <div className="action-icon">
          ...
          <Link to="/admin/dashboard/viewpayments" className="showcase-card">
            <div className="action-icon">
          ...
          <Link to="/admin/dashboard/updatepricing" className="showcase-card">
            <div className="action-icon">
