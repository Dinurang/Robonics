...
const Projects = () => {
  ...
  return (
    <>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6" data-aos="fade-right">
                ...
                <p className="hero-subtitle">
                  Showcasing Our Latest Robotic Innovations
                </p>
                <p className="hero-description">
                  Explore our portfolio of cutting-edge robotics projects. From industrial automation to 
                  intelligent navigation systems, we bring innovative ideas to life with precision engineering 
              ...
              <div className="col-lg-6" data-aos="fade-left">
                <div className="hero-image-container">
                  <img src={robotArm} alt="Robotic Arm" className="hero-image" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="row g-4">
              ...
              <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div className="project-card">
                  <div className="project-image-container">
                    <img src={robotArm} alt="Robotic Arm" className="project-image" />
                  </div>
                  <div className="project-content">
                    <h3>Industrial Robotic Arm</h3>
                    <p>A precision automation system for manufacturing with AI-powered control systems and 
                    advanced kinematics for complex tasks.</p>
                    <div className="project-tags">
                      <span className="project-tag">🤖 Robotics</span>
                      <span className="project-tag">⚙️ Automation</span>
                      <span className="project-tag">🤖 AI Control</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div className="project-card">
                  <div className="project-image-container">
                    <img src={robotCar} alt="Autonomous Car" className="project-image" />
                  </div>
                  <div className="project-content">
                    <h3>Autonomous Vehicle</h3>
                    <p>Self-driving technology with advanced sensor fusion, computer vision, and 
                    real-time navigation algorithms for smart transportation.</p>
                    <div className="project-tags">
                      <span className="project-tag">🚗 Autonomous</span>
                      <span className="project-tag">👁️ Computer Vision</span>
              ...
              <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div className="project-card">
                  <div className="project-image-container">
                    <img src={obstacleRobot} alt="Obstacle Robot" className="project-image" />
                  </div>
                  <div className="project-content">
                    <h3>Obstacle Detection Bot</h3>
                    <p>Intelligent navigation system using ultrasonic sensors and machine learning 
                    for real-time obstacle avoidance in challenging environments.</p>
                    <div className="project-tags">
                      <span className="project-tag">🛡️ Safety</span>
              ...
              <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div className="project-card">
                  <div className="project-image-container">
                    <img src={obstacleRobot} alt="3D Printing" className="project-image" />
                  </div>
                  <div className="project-content">
                    <h3>3D Printed Prototypes</h3>
                    <p>Custom robotic parts and prototypes created with cutting-edge 3D modeling 
                    and printing technologies for rapid development.</p>
                    <div className="project-tags">
                      <span className="project-tag">🖨️ 3D Printing</span>
                      <span className="project-tag">🎨 Design</span>
                      <span className="project-tag">⚡ Rapid Prototyping</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div className="project-card">
                  <div className="project-image-container">
                    <img src={robotCar} alt="Line Follower" className="project-image" />
                  </div>
                  <div className="project-content">
                    <h3>Line Follower Robot</h3>
                    <p>Precision tracking system using infrared sensors and PID control for 
                    accurate line following in industrial automation applications.</p>
                    <div className="project-tags">
                      <span className="project-tag">🎯 Precision</span>
              ...
              <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                <div className="project-card">
                  <div className="project-image-container">
                    <img src={robotArm} alt="CAD Design" className="project-image" />
                  </div>
                  <div className="project-content">
                    <h3>CAD Robotic Arm</h3>
                    <p>3D-modeled mechanical robotic arm designed using SolidWorks for pick-and-place 
                    automation tasks with precise movement control.</p>
                    <div className="project-tags">
                      <span className="project-tag">🖥️ CAD</span>
                      <span className="project-tag">📐 Design</span>
                      <span className="project-tag">⚙️ Mechanics</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-5 align-items-center">
              <div className="col-md-4" data-aos="zoom-in">
                <div className="showcase-card">
                  ...
                  <h4 className="mt-3">CAD & 3D Modeling</h4>
                  <p>SolidWorks, Fusion 360, AutoCAD for precision mechanical design</p>
                </div>
              </div>
              <div className="col-md-4" data-aos="zoom-in" data-aos-delay="200">
                <div className="showcase-card">
                  <div className="feature-icon">🤖</div>
                  <h4 className="mt-3">Robotics Frameworks</h4>
                  <p>ROS, Arduino, Raspberry Pi for embedded systems development</p>
                </div>
              </div>
              <div className="col-md-4" data-aos="zoom-in" data-aos-delay="400">
                <div className="showcase-card">
                  <div className="feature-icon">🧠</div>
                  <h4 className="mt-3">AI & Machine Learning</h4>
                  <p>TensorFlow, OpenCV for computer vision and intelligent control</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="cta-section py-5" data-aos="fade-up">
          <div className="container text-center">
            ...
            <p className="cta-description mb-4">
              Have a robotics project in mind? Let's bring your vision to life with our expert team 
      ...
      <style jsx>{`
        /* Projects Container - EXACT SAME AS HOME */
        .projects-container {
